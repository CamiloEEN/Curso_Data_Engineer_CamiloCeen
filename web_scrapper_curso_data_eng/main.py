...
def _news_scrapper(news_site_uid):
    ...
    # May need to print(host+link) to get full link
...
def _fetch_article(news_site_uid, host, link):
    logger.info('Start fetching article at link {}'.format(host+link))
...
if __name__ == '__main__':
    ...
    parser.add_argument('new_site', help='The news site that you want to scrappe', type=str, choices=news_site_choices)
